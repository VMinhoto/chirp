...
class ChatExceptionHandler {
    ...
    /**
     * Handle [InvalidProfilePictureException]. Returns Bad Request INVALID_PROFILE_PICTURE. With the message from
     * the exception.
     * @param e Exception
     */
    ...
    /**
     * Handle [StorageException]. Returns Bad Request STORAGE_ERROR. With the message from the exception.
     * @param e Exception
     */

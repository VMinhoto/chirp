package com.vminhoto.chirp.api.config

import com.vminhoto.chirp.domain.exception.RateLimitException
import com.vminhoto.chirp.infra.rate_limiting.IpRateLimiter
import com.vminhoto.chirp.infra.rate_limiting.IpResolver
                ...
                return try {
                    ipRateLimiter.withIpRateLimit(
                        ...
                        resetsIn = Duration.of(
                            annotation.duration, annotation.unit.toChronoUnit()
                        ),

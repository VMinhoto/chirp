package com.vminhoto.chirp.infra.rate_limiting

import com.vminhoto.chirp.infra.config.NginxConfig
    ...
    fun getClientIp(request: HttpServletRequest): String {
        ...
        if(!isFromTrustedProxy(remoteAddr)) {
            if(nginxConfig.requireProxy) {
                ...
                throw SecurityException("No valid ip client IP in proxy headers")
            }
